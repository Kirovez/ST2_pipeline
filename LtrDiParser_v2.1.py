...
class LTR():
    ...
    def isFull(self):
        ...
        return self.classification_status_domains[-1] == STATUS_TE_FULL
...
class LtrDiParser():
        ...
        with open(outfile_name, "w") as outfile:
            ...
            for ltrs in self.LTRs:
                ...
                base = "\t".join([ltrs+"<*>"+self.LTRs[ltrs].chromosome,
                                  ...
                                  status, classification, domains, self.LTRs[ltrs].getBestHit("RT"), self.LTRs[ltrs].getDomainsPresenceNot()
                                 ])
            ...
            for re in self.LTRs:
                ...
                for domains_unqiue in per_domain:
                    ...
                    if domains_unqiue != "long_terminal_repeat":
                        ...
                        outfile.write("\t".join(longest_hit) + "\t"  + te_id + "\n")
                    else:
    ...
    def getBED_LTR_coordinates(self):
        with open(self.gff3File + ".bed", "w") as outFile:
            cnt = 0
